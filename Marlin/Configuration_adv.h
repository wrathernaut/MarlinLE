 ...
 */
  ...
  //#define DISPLAY_ITERATION_MESSAGES    // Display progress messages to the screen
...
#if ANY(TAZPro, TAZProXT, TAZ8, TAZ8XT, MiniV2, MiniV3)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #if EXTRUDERS > 1
    #define EVENT_GCODE_SD_ABORT "M83\nG0 E-14\nM82\nG0 Y" STRINGIFY(LULZBOT_Y_MAX_POS) " Z" STRINGIFY(LULZBOT_Z_MAX_POS) " F2500\nG91\nG0 Z-2\nG90\nT0"
  #else
    #define EVENT_GCODE_SD_ABORT "M83\nG0 E-14\nM82\nG0 Y" STRINGIFY(LULZBOT_Y_MAX_POS) " Z" STRINGIFY(LULZBOT_Z_MAX_POS) " F2500\nG91\nG0 Z-2\nG90"
  #endif
 ...
 */
 ...
 #define CUSTOM_MENU_MAIN_TITLE "Tool Heads"
  ...
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle
    ...
    #if ANY(MiniV2, Workhorse, TAZPro, TAZProXT, TAZ8, TAZ8XT)
