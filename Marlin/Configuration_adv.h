...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0.25, 0.25, 0.04 } // (linear=mm, rotational=°) One value for each linear axis
...
#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_OBJECT_CENTER     { 263.0, -13.5,  -2.0 } // (mm)
 ...
 */
  ...
  #define LCD_TIMEOUT_TO_STATUS (15*60000)   // (ms) 15 min for timeout
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "M83\nG0 E-14\nM82\nG0 Y" Y_MAX_POS " Z" Z_MAX_POS -5 " F2500\nG91\nG0 Z-2\nG90\nT0"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
...
#define USE_WATCHDOG
  ...
  #define WATCHDOG_DURATION_8S //carryover from lulz
