 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#if ANY(TAZPro, TAZProXT, TAZ8, TAZ8XT, MiniV3)
 ...
 */
#if ANY(TOOLHEAD_Universal_DualExtruder, TOOLHEAD_Galaxy_DualExtruder)
  #define SWITCHING_NOZZLE
#endif
 ...
 */
  ...
  #else
    #define NOZZLE_TO_PROBE_OFFSET { 23, 63, -1.2 }
  #endif
#elif ANY(SideKick_289, SideKick_747)
  #define NOZZLE_TO_PROBE_OFFSET { -1, 50, -1.2 }
#elif ENABLED(Workhorse2)
...
#if ANY(Workhorse, TAZ8, TAZ8XT, TAZDualZ)
...
#if LULZBOT_EXTRUDERS == 2 && NONE(TAZPro, TAZProXT, TAZ8, TAZ8XT)
