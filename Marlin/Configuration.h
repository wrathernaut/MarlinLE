...
#define STRING_CONFIG_H_AUTHOR "Wrathernaut" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "TAZPro DualOrbiter" // Name for your machine that will be displayed on the LCD and in the host software
...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { {55, 100} , {55, 100} }   // A pair of angles for { E0, E1 }.
                                                    // For Dual Servo use two pairs: { { lower, raise }, { lower, raise } }
  #define SWITCHING_NOZZLE_SERVO_DWELL 300         // Dwell time to wait for servo to make physical move
...
#define HOTEND_OFFSET_X { 0.0, 67.87 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -0.20 }  // (mm) relative Y-offset for each nozzle
#define HOTEND_OFFSET_Z { 0.0, 0.67 }  // (mm) relative Z-offset for each nozzle
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  286.02
  #define DEFAULT_BED_KI   54.55
  #define DEFAULT_BED_KD  374.9
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW //MICROSWITCH
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 500, 690 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 40 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 900, 900, 50, 80 } // ...or, set your own edit limits
#endif
 ...
 */
#define FIX_MOUNTED_PROBE //microswitch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33.17, 0, 3.47 } //dual orbiter
...
#define PROBE_OFFSET_YMAX    10   // (mm)
...
#define X_MIN_POS -36 //check lulz toolhead mods
#define Y_MIN_POS -37
#define Z_MIN_POS -9
#define X_MAX_POS 279
#define Y_MAX_POS 291
#define Z_MAX_POS 292
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define AUTO_BED_LEVELING_UBL //wrath YOLO!
 ...
 */
#define EVENT_GCODE_BEFORE_G29 "M280 P0 S100\nM280 P1 S100" //lift both tools

/**
 * Commands to execute at the end of G29 probing.
 * Useful to retract or move the Z probe out of the way.
 */
#define EVENT_GCODE_AFTER_G29 "G1 Z10 F6000\nM280 P0 S55" //lift and deploy tool 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3 //-wrath reduced for initial build      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define PREHEAT_2_LABEL       "ABS/HIPS"
...
// carryover from lulz in case it's needed - makes preheat commands for both nozzles
...
#define NOZZLE_PARK_FEATURE
  ...
  #define PARK_NOZZLE_MENU_OPTION     // Add "Park Nozzle" to the LCD menu in motion menu
  ...
  #define PARKING_COMMAND_GCODE "G28O\nG0 X" X_CENTER-5 " Y" Y_CENTER " Z70 F6000\nG0 X" X_CENTER
...
#define M109_M190_DO_NOT_START_TIMER //carryover from lulz to prevent M109 and M190 from starting the timer
// @section stats
